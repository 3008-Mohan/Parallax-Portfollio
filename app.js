...
const jobTitleContainers = document.querySelector(".jobContainer")
const jobTitles = document.querySelector(".job")
...
for (let i=0;i<365;i++){
    ...
    const list = [
        ...
        133, 134, 172,174, 173, 213, 214, 254, 255, 295, 296, 175, 176, 217, 177, 218,
        ...
        283, 284, 285, 323, 324, 325, 326,190,196
      ];
...
boxContainer.addEventListener("click",()=>{
    openInNewTab('https://github.com/3008-Mohan?tab=repositories');
})
